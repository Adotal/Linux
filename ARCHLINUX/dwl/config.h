...
// static const char *fonts[]					= {"Dejavu Sans Mono"};
...
static const struct xkb_rule_names xkb_rules = {
	...
	*/
	// .options = NULL,
	// Default is us, but it can be switched between latam (spanish) and de (deutsch)
	.layout = "us,latam,de",
    .variant = ",,",
...
static const Key keys[] = {
	...
	{ 0,						 XKB_KEY_XF86MonBrightnessDown,	spawn,		{.v = brightnessdw} },
	{ 0,						 XKB_KEY_Print,				spawn,			{.v = fullscrot} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_s,					spawn,			{.v = selscrot} },
	{ WLR_MODIFIER_ALT,			 XKB_KEY_F4,				killclient, 	{0} },
	{ MODKEY,                    XKB_KEY_F11,	            togglefullscreen,{0} },
	{ MODKEY|WLR_MODIFIER_ALT,	 XKB_KEY_r,					spawn,			{.v = reboot} },
	{ MODKEY|WLR_MODIFIER_ALT,	 XKB_KEY_q,					spawn,			{.v = shutdown} },
	{ 0,						 XKB_KEY_XF86AudioRaiseVolume, spawn,		{.v = volup} },
	{ 0,						 XKB_KEY_XF86AudioLowerVolume, spawn,		{.v = voldw} },
	...
	{ MODKEY|WLR_MODIFIER_ALT,   XKB_KEY_f,       	setlayout,        {0} },
